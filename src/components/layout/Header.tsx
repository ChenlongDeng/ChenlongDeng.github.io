  ...
  return (
    <li>
      ...
      >
        {children}
        {isActive && (
          <span className="absolute inset-x-1 -bottom-px h-[2px] bg-gradient-to-r from-primary/0 via-primary/40 to-primary/0" />
        )}
      </Link>
    </li>
  )
...
function DesktopNavigation(props: React.ComponentPropsWithoutRef<'nav'>) {
  return (
    <nav {...props}>
      <ul className="flex rounded-2xl px-4 py-2 text-base font-medium bg-background/70 ring-1 ring-muted shadow-lg backdrop-blur-md">
              ...
              >
                <div className="relative">
                  ...
                  <div className="flex flex-row items-center gap-4">
                    ...
                    />
                    <div
                      className="text-3xl md:text-4xl font-bold tracking-tight flex flex-row"
                      style={{
